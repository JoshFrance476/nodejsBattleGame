...
export default class Board {
    ...
    for (let i = 0; i<gridy; i++)
    {
      ...
      {
        this.board.push(new Tile(i, j, 10, 5))
      }
    }}
     ...
     */
    getTile(tileId) {
      return this.board.find(tile => tile.id === tileId);
    }
     ...
     */
    moveTroops(tileIdTo, tileIdFrom, troopCount) {
      const tileTo = this.getTile(tileIdTo);
      const tileFrom = this.getTile(tileIdFrom);
